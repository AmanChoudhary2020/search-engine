...
def get_hits():
    ...
    hits = do_calculations(docs_w_query,
...
def do_calculations(docs_w_query, entire_info, weight, term_freq_in_q):
    """Return information.
    ...
    for _ in docs_w_query:
        ...
        hits.append({"docid": int(entire_info[word_in][entire_info_i][1]),
